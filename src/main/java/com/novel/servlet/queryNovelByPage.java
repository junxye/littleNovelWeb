...
public class queryNovelByPage extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
        ...
        String _param = request.getParameter("_param");//搜索框的参数
        ...
        Map<String, String> parameterMap = new HashMap<>();//放参数的map
        Map<String, String> conditionMap = new HashMap<>();//放排序条件的map
        parameterMap.put("_param", _param);
        parameterMap.put("_category", _category);
        ...
        request.setAttribute("novelPage", novelPages);
